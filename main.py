...
def check_img(imagem): # def para checar se determinada imagem existe
    start = pyautogui.locateCenterOnScreen(f'{imagem}.png',confidence=0.9)#If the file is not a png file it will not work
    return start
...
def get_size(imagem): # retorna o tamanho de uma imagem
    imm = PIL.Image.open(f'{imagem}.png')
    im=imm.size
    return im
...
def get_battlelist():
    ...
    l = pyautogui.locateOnScreen(r'list_fim.png',confidence=0.9, region=(int(x_mod),int(y), int(w), int(h)))
...
def cast_spell(magia,hotkey):
    caminho_magia = 'magias/' + magia + '.png'
...
def get_minimap():
    ...
    o = pyautogui.locateOnScreen(r'minimap.png')
    xc = o.left-13-106
    yc = o.top-92
    wc = 106
    hc = 109
...
def get_andar():
    o = pyautogui.locateOnScreen(r'minimap.png')
    while o==None:
        o = pyautogui.locateOnScreen('minimap.png')
    xc = o.left-13-106+108
    yc = o.top-92
    wc = 58
    hc = 109+8
    p = pyautogui.locateOnScreen(r'seta_mapa.png', region=(xc, yc, wc, hc), confidence=0.8)
    while p==None:
        p=pyautogui.locateOnScreen(r'seta_mapa.png',region=(xc,yc,wc,hc), confidence=0.8)
...
def check_ammo():
    ...
    s = pyautogui.locateOnScreen(r'pvp.png')
    var1='0'
    var2='0'
    var3='0'
    var4='0'
    ...
    while i <= 4:
        for j in lst:
            ...
            w=8
            h=10
            u = pyautogui.locateOnScreen(f'numeros/ammo/{j}.png',region=(x,y,w,h),confidence=0.89)
            if u != None:
                if i==1:
                    var1 = j
                elif i==2:
...
def check_supply(supply='great_mana_potion'):
    ...
    while i <= 4:
        for j in lst:
            ...
            x_f=0
            y_f=0
            q=pyautogui.locateCenterOnScreen(f'itens/{supply}.png',region=(0,96,70,430),confidence=0.9)
            ...
            if coluna<=1:
                ...
                x_f=38
            y_f=97+(linha-1)*36
            u = pyautogui.locateOnScreen(f'numeros/supply/{j}.png', region=(x_f+31-6*i,y_f+31-8,6,8), confidence=0.85)
...
def andar(waypoint):
    ...
    while qtde_zero <= 2: #tentativas de localizar o wp
        ...
        if l!=None: #caso encontre o wp
            ...
            no_way = pyautogui.locateOnScreen('no_way.png',confidence=0.8) #verifica se a mensagem de There is no way aparece na tela
...
def vender_itens():
    ...
    while janela_sell != None:
        sell_btn = pyautogui.locateCenterOnScreen('sell_focus_off.png')
    ...
    while i < janela_itens.size[1]:
        ...
        while p != (192,192,192) and i < janela_itens.size[1]:
            ...
            if p == (192,192,192):
                ...
                sleep(0.2)
                pyautogui.moveTo(544, 315)
                seta_direita = pyautogui.locateOnScreen(r'npc_trade_seta_direita.png',region=(int(x_2),int(y_2),int(w_2),int(h_2)))
                pyautogui.click(seta_direita.left-7,seta_direita.top+3,clicks=3)
                sleep(0.2)
                pyautogui.moveTo(544, 315)
                ok_btn = pyautogui.locateCenterOnScreen(r'npc_trade_ok.png',region=(int(x_2),int(y_2),int(w_2),int(h_2)))
...
def ajustar_zoom(nivel):
    ...
    p=pyautogui.locateCenterOnScreen(r'zoom_in.png')
    pyautogui.click(p,clicks=10)
    p = pyautogui.locateCenterOnScreen(r'zoom_out.png')
...
def comprar_itens(item,texto,total):
    ...
    busca = pyautogui.locateOnScreen(r'type_search.png', confidence=0.9)
    ...
    item_txt = pyautogui.locateOnScreen(f'{item}.png', confidence=0.8)
    pyautogui.click(item_txt)

    quantidade = pyautogui.locateOnScreen(r'compra_selecionada.png', confidence=0.9)
    ...
    pyautogui.moveTo(544, 315)
    sleep(1)
    ok_btn = pyautogui.locateOnScreen(r'npc_trade_ok.png', confidence=0.9)
...
def chat_on():
    chat_off = pyautogui.locateOnScreen(r'chat_off.png')
    while chat_off != None:
...
def chat_off():
    chat_on = pyautogui.locateOnScreen(r'chat_on.png')
    while chat_on != None:
...
def chat_npc_active():
    chat_npc = pyautogui.locateOnScreen(r'chat_npc_off.png')
    while chat_npc != None:
...
def verifica_chat(desejo):
    c=pyautogui.locateOnScreen(r'chat_on.png')
    if c==None:
        c=pyautogui.locateOnScreen(r'chat_off.png')
        estado='off'
    else:
        estado='on'
    if desejo!=estado:
        p=pyautogui.locateCenterOnScreen(r'chat.png')
        pyautogui.click(p)
    sleep(0.2)
    pyautogui.moveTo(544, 315)
...
def verifica_aba_npc():
    c=pyautogui.locateCenterOnScreen(r'aba_npc_off.png')
    if c==None:
        c=pyautogui.locateOnScreen(r'aba_npc_on.png')
        if c==None:
            d=pyautogui.locateCenterOnScreen(r'pastas.png')
            pyautogui.click(d)
            sleep(0.1)
            e=pyautogui.locateCenterOnScreen(r'aba_npc.png')
            pyautogui.click(e)
            sleep(0.1)
            f=pyautogui.locateCenterOnScreen(r'aba_open.png')
            pyautogui.click(f)
    pyautogui.click(c)
...
def auto_ring(hotkey='u'):
    while(True):
        try:
            p=pyautogui.locateCenterOnScreen(r'ring_off.png')
            if p!=None:
...
def get_game_window():
    x=pyautogui.locateOnScreen(r'abas_hotkey_cima.png')
    ...
    y=pyautogui.locateOnScreen(r'xp_icon.png')
    yc=y.top+37
        ...
        try:
            ...
            for i in range(1,scr.size[0]):
                for j in range(1,scr.size[1]):
                    ...
                    if pixel==(96,248,248):
                        AudioPlayer(r"alerta_mensagem.mp3").play(block=True)
                        parar=1
                        break
                    if parar==1:
                        break
...
def player_on_screen():
    while(True):
        try:
            p=pyautogui.locateOnScreen(r'battlelist_ini_player.png')
            size=pyautogui.size()
            f=pyautogui.locateOnScreen(r'list_fim_2.png',region=(p.left,p.top,size.width-p.left,size.height-p.top),confidence=0.6)
            ...
            for i in range(1,ptr.size[1]):
                ...
                if pixel==(0,0,0):
                    AudioPlayer(r"player_na_tela.mp3").play(block=True)
                    break
        except:
            continue
...
def anti_bot():
    while(True):
        try:
            f=pyautogui.locateOnScreen(r'anti_bot.png')
            if f==None:
                AudioPlayer(r"player_na_tela.mp3").play(block=True)
        except:
            continue
...
def follow_on():
    while(True):
        try:
            f=pyautogui.locateCenterOnScreen(r'follow_off.png')
            if f!= None:
                pyautogui.click(f)
                sleep(0.2)
                pyautogui.moveTo(544, 315)
...
def follow_off():
    while(True):
        try:
            f=pyautogui.locateCenterOnScreen(r'follow_on.png')
            if f!= None:
                pyautogui.click(f)
                sleep(0.2)
                pyautogui.moveTo(544, 315)
...
def deposit_dp():
    ...
    t=0
    while t==0:
        dp_spot = pyautogui.locateCenterOnScreen(r'dp_spot.png', confidence=0.7)
        pyautogui.moveTo(dp_spot)
        pyautogui.click(button='left')
        sleep(3)
        for w in range(0,99):
    ...
    #clica no box do dp
    locker=pyautogui.locateCenterOnScreen(r'locker.png',confidence=0.8)
    while locker==None:
        locker = pyautogui.locateCenterOnScreen(r'locker.png',confidence=0.8)
        if locker != None:
            break
        else:
            k = pyautogui.locateCenterOnScreen(r'dp_box.png', region=(x, y, w, h), confidence=0.9)
            pyautogui.moveTo(k)
            pyautogui.click(button='right')

    #fecha bp aberta
    backpack_open=pyautogui.locateOnScreen(r'backpack.png',confidence=0.8)
    while backpack_open != None:
        ...
        if backpack_open == None:
            ...
            fechar = pyautogui.locateCenterOnScreen(r'fechar.png',region=(backpack_open.left, backpack_open.top, 170, 15),confidence=0.8)
    ...
    #reabre janela da bp
    backpack_open = pyautogui.locateCenterOnScreen(r'backpack.png')
    while backpack_open == None:
        backpack_open = pyautogui.locateCenterOnScreen(r'backpack.png')
        if backpack_open != None:
            break
            ...
            storage = pyautogui.locateOnScreen(r'storage_inbox.png')
    ...
    backpack_open_2 = pyautogui.locateOnScreen(r'backpack.png')
    fim_bp=pyautogui.locateOnScreen(r'list_fim.png',region=(backpack_open_2.left-20+158,backpack_open_2.top,20,400),confidence=0.8)
    ...
    backpack_open_2 = pyautogui.locateOnScreen(r'backpack.png')
    fim_bp = pyautogui.locateOnScreen(r'list_fim.png',region=(backpack_open_2.left - 20 + 158, backpack_open_2.top, 20, 400),confidence=0.8)
    item_valuables = os.listdir('valuables')
    backpacks = os.listdir('containers')
    ...
    while m==0:
        ...
        for l in item_valuables:
            item=pyautogui.locateCenterOnScreen(f'valuables/'+l,region=(-10+backpack_open_2.left,backpack_open_2.top,fim_bp.left- backpack_open_2.left+10,fim_bp.top- backpack_open_2.top+10),confidence=0.8)
            if item != None:
                stash=pyautogui.locateCenterOnScreen(r'stash.png',confidence=0.8)
    ...
    while j==0:
        k=0
        for i in backpacks:
            bp=pyautogui.locateCenterOnScreen(f'containers/'+i,region=(-10+backpack_open_2.left,backpack_open_2.top,fim_bp.left- backpack_open_2.left+10,fim_bp.top- backpack_open_2.top+10),confidence=0.8)
            if bp != None:
                pyautogui.moveTo(bp)
                pyautogui.click(button='right')
                ...
                while m == 0:
                    o = 0
                    for l in item_valuables:
                        item = pyautogui.locateCenterOnScreen(f'valuables/' + l, region=(
    ...
    # reabre janela da bp
    backpack_open = pyautogui.locateCenterOnScreen(r'backpack.png',confidence=0.8)
    while backpack_open == None:
        backpack_open = pyautogui.locateCenterOnScreen(r'backpack.png',confidence=0.8)
        if backpack_open!=None:
            break
